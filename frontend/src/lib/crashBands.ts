...
export const CRASH_COUNT_BANDS = [
  { min: 0, band: 'green', color: '#2E9E5B', label: '0–4' },
  { min: 5, band: 'yellow', color: '#E5B917', label: '5–9' },
  { min: 10, band: 'orange', color: '#E8843C', label: '10–19' },
  { min: 20, band: 'red', color: '#D6453D', label: '20–49' },
  { min: 50, band: 'purple', color: '#A63BC4', label: '50+' },
] as const

export const UNAVAILABLE_CRASH_BAND = {
  band: 'unavailable', color: '#8A9496', label: 'Data unavailable',
} as const
